...
class LeccoUserModel: LeccoBaseModel {
    ...
    var avatar_larger:LeccoAvatarModel?
    ...
    var avatar_medium:LeccoAvatarModel?
    var verify_info:String?
    var create_time:Int?
    var story_open:Bool?
    var policy_version:LeccoPolicy_versionModel?
    var region:String?
    var hide_search:Bool?
    var avatar_thumb:LeccoAvatarModel?
    var school_poi_id:String?
    var shield_comment_notice:Int?
    var total_favorited:Int?
    var video_icon:LeccoVideo_iconModel?
    ...
    var activity:LeccoActivityModel?
    var user_rate:Int?
    var video_icon_virtual_URI:String?
}


class LeccoAvatarModel: LeccoBaseModel {
    var url_list = [String]()
    var uri:String?
}

class LeccoPolicy_versionModel: LeccoBaseModel {
    
}

class LeccoGeofencingModel: LeccoBaseModel {
    
}

class LeccoVideo_iconModel: LeccoBaseModel {
    var url_list = [String]()
    var uri:String?
}

class LeccoActivityModel: LeccoBaseModel {
