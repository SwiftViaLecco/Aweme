...
class LeccoVideoListCell: UITableViewCell {
    ...
    var aweme:LeccoAwemeModel?
    
    var playerView:LeccoPlayerView = LeccoPlayerView()
...
//        }
    ...
    func initData(aweme:LeccoAwemeModel) {
        self.aweme = aweme
...
extension LeccoVideoListCell {
    ...
    func startLoadingPlayItemAnim(_ isStart:Bool = true) {
        if isStart {
            ...
            scaleAnim.toValue = 1.0 * kScreenWitdh
...
//extension LeccoVideoListCell: SendTextDelegate, HoverTextViewDelegate {
//
...
extension LeccoVideoListCell: LeccoPlayerUpdateDelegate {
