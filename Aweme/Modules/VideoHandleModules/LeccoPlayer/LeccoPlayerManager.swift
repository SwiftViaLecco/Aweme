...
class LeccoPlayerManager: NSObject {
    
    var playerArray = [AVPlayer]()
    
    private static let instance = { () -> LeccoPlayerManager in
        return LeccoPlayerManager()
    }()
    ...
    class func shared() -> LeccoPlayerManager {
        return instance
    }
